...
**Einnahmen-Ausgaben-Rechner** — also die meisten EPU und kleinen Betriebe — müssen kein Kassenbuch im engeren Sinn führen. Die Einzelaufzeichnungspflicht für Barumsätze gilt aber trotzdem, und die erfüllt in der Praxis die [Registrierkasse](/ratgeber/registrierkassenpflicht-oesterreich). Viele führen das Kassenbuch freiwillig weiter, weil es den Überblick über die Kassa und die Zusammenarbeit mit der Steuerberatung deutlich erleichtert.
...
- **Aufbewahrung:** In Österreich 7 Jahre; in Deutschland gelten 10 Jahre für das Kassenbuch (Belege: 8 Jahre — mehr dazu im [KassenSichV-Ratgeber](/ratgeber/kassensichv-tse-deutschland)).

## Die teuersten Fehler

Bei Prüfungen fallen immer dieselben Muster auf — und führen schlimmstenfalls zur **Umsatzschätzung durch das Finanzamt**:

1. **Negativer Kassenstand:** Eine Kassa kann nie unter null fallen. Taucht das im Kassenbuch auf, ist die Buchführung formal nicht ordnungsgemäß.
2. **Excel-Kassenbuch:** Tabellenkalkulationen sind beliebig änderbar und gelten deshalb nicht als unveränderbare Aufzeichnung — ein Klassiker unter den Beanstandungen.
3. **Sammelbuchungen:** „Einnahmen KW 23 pauschal" statt einzelner Bewegungen.
4. **Fehlende Eigenbelege** bei Privatentnahmen und -einlagen.
5. **Kassenbuch und Kasse widersprechen sich:** Wenn Registrierkasse und Kassenbuch getrennt gepflegt werden, schleichen sich Differenzen ein.

## Der einfache Weg: Kassenbuch direkt aus der Kasse

Der letzte Punkt zeigt die eigentliche Lösung: Das Kassenbuch gehört **in das Kassensystem integriert**, nicht daneben. Bei Orderlyze überträgt das [Kassenbuch-Add-on (13 € pro Monat)](/preise) alle Bar-Transaktionen automatisch aus der Kasse — fortlaufend nummeriert, mit getrennten Mehrwertsteuer-Positionen, aktuellem Kassenstand und [Export für die Steuerberatung](/datenexport-steuerberater). Negative Kassenstände, Übertragungsfehler und Nachtrag-Marathons fallen damit konstruktionsbedingt weg.
