...
Unabhängig von den Umsatzgrenzen gilt die **Belegerteilungspflicht** (§ 132a BAO): Du musst **ab dem ersten Barumsatz** einen Beleg ausstellen und deiner Kundschaft übergeben. Der Beleg kann gedruckt oder elektronisch sein — mit Orderlyze zum Beispiel auch als [E-Beleg per QR-Code](/funktionen) direkt aufs Handy.
